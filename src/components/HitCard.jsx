...
const HitCard = ({ product }) => (
  <div className="bg-white border border-gray-100 rounded-xl p-2 flex gap-2 hover:shadow-md transition">
    <div className="relative shrink-0">
      <span className="absolute -top-1 -left-1 bg-red-500 text-white text-[9px] font-bold w-5 h-5 rounded-full flex items-center justify-center z-10">ХИТ</span>
    ...
    <div className="text-[10px] flex-1 min-w-0">
      ...
      <div className="font-bold text-xs">{product.price} руб.</div>
      <div className="flex">
        {[1,2,3,4,5].map(i => (
