    ...
    <Modal onClose={onClose} maxWidth="max-w-2xl">
      <div className="p-6">
        {sent ? (
          ...
          <>
            <h2 className="text-xl font-bold mb-3">Order in one click</h2>
            ...
            <div className="flex gap-4 mb-4 p-3 bg-gray-50 rounded-xl">
              <div className="relative shrink-0">
                <span className="absolute top-0 left-0 bg-primary-500 text-white text-xs px-2 py-0.5 rounded">Product of the day</span>
                <img src={product.image} alt={product.name} className="w-32 h-24 object-cover rounded" />
              </div>
              <div className="flex-1">
                <span className="text-primary-500 text-sm">In stock</span>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <button onClick={() => setQty(qty + 1)} className="w-8 h-8 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold">+</button>
                </div>
              </div>
            </div>
            <form onSubmit={submit} className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <input required placeholder="Enter Your name" className="px-4 py-3 border-2 border-gray-200 rounded-full focus:border-primary-500 focus:outline-none" />
                <input required type="tel" placeholder="Phone" className="px-4 py-3 border-2 border-gray-200 rounded-full focus:border-primary-500 focus:outline-none" />
              </div>
              <button type="submit" className="w-full bg-primary-500 text-white font-bold py-3 rounded-full">Place order</button>
